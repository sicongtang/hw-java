package com.sicongtang.jdk.tutorial.jaxb.j2sxmlAdapter;
...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		try {
			KitchenWorldBasket kwBasket = (KitchenWorldBasket) u.unmarshal(new File(
					"src/main/java/com/sicongtang/jdk/tutorial/jaxb/j2sxmlAdapter/shoppingCartData.xml"));
