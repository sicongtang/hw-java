package com.sicongtang.jdk.tutorial.jaxb.j2sxmlType;
...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		try {
			PurchaseOrderType poType = (PurchaseOrderType) u.unmarshal(new File("src/main/java/com/sicongtang/jdk/tutorial/jaxb/j2sxmlType/testData.xml"));
